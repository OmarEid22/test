...
public class JwtService {
    private static final String SECRET_KEY = "uAer1twja82GjewZ2BjW7KvphLs64YKDQa7H/nk9z7A/QouhTAOKTh34oNsadtIz";
    ...
    public boolean isTokenVailid(String token, UserDetails userDetails) {
        final String username = extractUsername(token);
        return (username.equals(userDetails.getUsername())) && !isTokenExpired(token);
    }
